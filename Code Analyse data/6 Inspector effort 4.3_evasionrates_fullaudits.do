...
twoway (kdensity evasionrate if selectionyear==2018) || ///
    ...
    pos(6) ring(1) cols(3))
graph export "$output/kdensity_evasionrate_syear_fullaudits.pdf", replace
...
forval sample = 1/3 {
	preserve	
		...
		*local sample = 3 `cond`sample'' 
		collapse (sum) total_assigned total_executed null_evasion belowmedian_er bottomquartile_er `cond`sample'' , by(method groupbureau bureau selectionyear) 
...
* collapse at the inspector year level		
	collapse (sum) total_assigned* total_executed* null_evasion* bottomquartile_er* belowmedian_er*, by(bureau selectionyear)
	egen tag_bureau = tag(bureau)
		** Generating total
		*Total execution
...
*generating shares among methods
		...
		*make the scatter plot 
		...
		keep bureau selectionyear  share_v_Algorithm_all share_v_Algorithm ///  
...
***cap labelling some vars
	...
	* 2018
	*========================================================
	cap label var share_v_Algorithm_all2018            "Share of void cases, Algorithm (all, 2018)"
	cap label var share_v_Algorithm2018                "Share of void cases, Algorithm (2018)"
	...
	cap label var share_med_er_Algorithm_all2018         "Share of below-median evasion rate cases, Algorithm (all, 2018)"
	cap label var share_med_er_Algorithm2018             "Share of below-median evasion rate cases, Algorithm (2018)"
	...
	cap label var share_botq_er_Algorithm_all2018        "Share of bot-quartile evasion rate cases, Algorithm (all, 2018)"
	cap label var share_botq_er_Algorithm2018            "Share of bot-quartile evasion rate cases, Algorithm (2018)"
	...
	* 2019
	*========================================================
	cap label var share_v_Algorithm_all2019            "Share of void cases, Algorithm (all, 2019)"
	cap label var share_v_Algorithm2019                "Share of void cases, Algorithm (2019)"
	...
	cap label var share_med_er_Algorithm_all2019         "Share of below-median evasion rate cases, Algorithm (all, 2019)"
	cap label var share_med_er_Algorithm2019             "Share of below-median evasion rate cases, Algorithm (2019)"
	...
	cap label var share_botq_er_Algorithm_all2019        "Share of bot-quartile evasion rate cases, Algorithm (all, 2019)"
	cap label var share_botq_er_Algorithm2019            "Share of bot-quartile evasion rate cases, Algorithm (2019)"
	...
	* 2020
	*========================================================
	cap label var share_v_Algorithm_all2020            "Share of void cases, Algorithm (all, 2020)"
	cap label var share_v_Algorithm2020                "Share of void cases, Algorithm (2020)"
	...
	cap label var share_med_er_Algorithm_all2020         "Share of below-median evasion rate cases, Algorithm (all, 2020)"
	cap label var share_med_er_Algorithm2020             "Share of below-median evasion rate cases, Algorithm (2020)"
	...
	cap label var share_botq_er_Algorithm_all2020        "Share of bot-quartile evasion rate cases, Algorithm (all, 2020)"
	cap label var share_botq_er_Algorithm2020            "Share of bot-quartile evasion rate cases, Algorithm (2020)"
	...
	*========================================================
	cap label var share_v_Algorithm_allavg             "Share of void cases, Algorithm (all,2019-2020)"
	cap label var share_v_Algorithmavg                 "Share of void cases, Algorithm (2019-2020)"
	...
	cap label var share_med_er_Algorithm_allavg          "Share of below-median evasion rate cases, Algorithm (all,2019-2020)"
	cap label var share_med_er_Algorithmavg              "Share of below-median evasion rate cases, Algorithm (2019-2020)"
	...
	cap label var share_botq_er_Algorithm_allavg         "Share of bot-quartile evasion rate cases, Algorithm (all,2019-2020)"
	cap label var share_botq_er_Algorithmavg             "Share of bot-quartile evasion rate cases, Algorithm (2019-2020)"
	...
	cap label var share_botq_er_Inspectorsavg      "Share of bot-quartile evasion rate cases, Inspectors (2019-2020)"
        ...
        * Total (all inspectors)
        eststo bureau_share_`sample': estpost summarize ///
            ...
            share_v_all_t     share_v_Algorithm_t     share_v_Inspectors_t ///
			share_med_er_all_t share_med_er_Algorithm_t share_med_er_Inspectors_t  ///
			share_botq_er_all_t share_botq_er_Algorithm_t share_botq_er_Inspectors_t ///
            share_exec_all_t1 share_exec_Algorithm_t1 share_exec_Inspectors_t1 ///
            share_v_all_t1     share_v_Algorithm_t1     share_v_Inspectors_t1 ///
			share_med_er_all_t1 share_med_er_Algorithm_t1 share_med_er_Inspectors_t1  ///
			share_botq_er_all_t1 share_botq_er_Algorithm_t1 share_botq_er_Inspectors_t1 ///
     ...
     foreach met in Algorithm Inspectors {
        ...
        * Total (all inspectors)
        eststo bureau_has_`sample': estpost tabstat ///
            ...
            has_void_all_t     has_void_Algorithm_t     has_void_Inspectors_t ///
			has_med_er_all_t 	has_med_er_Algorithm_t has_med_er_Inspectors_t ///
			has_botq_er_all_t 	has_botq_er_Algorithm_t has_botq_er_Inspectors_t ///
            has_executed_all_t1 has_executed_Algorithm_t1 has_executed_Inspectors_t1 ///
            has_void_all_t1     has_void_Algorithm_t1     has_void_Inspectors_t1 ///
			has_med_er_all_t1 	has_med_er_Algorithm_t1 has_med_er_Inspectors_t1 ///
			has_botq_er_all_t1 	has_botq_er_Algorithm_t1 has_botq_er_Inspectors_t1, ///
            stat(sum) columns(statistics)
		**# Generating graphs 

foreach share in share_exec_all share_exec_Algorithm share_exec_Inspectors ///
                 share_v_all   share_v_Algorithm   share_v_Inspectors ///
                 share_med_er_all share_med_er_Algorithm share_med_er_Inspectors ///
                 share_botq_er_all share_botq_er_Algorithm share_botq_er_Inspectors {
    ...
    * -----------------------------
    if "`share'" == "share_v_all" {
        ...
        local x_title "Void rate, all audits, year t"
        local y_title "Execution rate, all audits, year t+1"
    }
    else if "`share'" == "share_v_Algorithm" {
        local y_t     "share_exec_Algorithm`t'"
        local y_t1    "share_exec_Algorithm`t1'"
        local x_title "Void rate, algo audits, year t"
        ...
        local x_title "Void rate, inspector audits, year t"
        local y_title "Execution rate, inspector audits, year t+1"
    }
    else if "`share'" == "share_med_er_all" {
        local y_t     "share_exec_all`t'"
        local y_t1    "share_exec_all`t1'"
        local x_title "% below median evasion rate - all audits, year t"
        local y_title "Execution rate - all audits, year t+1"
    }
    else if "`share'" == "share_med_er_Algorithm" {
        local y_t     "share_exec_Algorithm`t'"
        local y_t1    "share_exec_Algorithm`t1'"
        local x_title "% below median evasion rate - Algo audits, year t"
        local y_title "Execution rate - algo audits, year t+1"
    }
    else if "`share'" == "share_med_er_Inspectors" {
        local y_t     "share_exec_Inspectors`t'"
        local y_t1    "share_exec_Inspectors`t1'"
        local x_title "% below median evasion rate - Inspector audits, year t"
        local y_title "Execution rate - inspector audits, year t+1"
    }
    else if "`share'" == "share_botq_er_all" {
        local y_t     "share_exec_all`t'"
        local y_t1    "share_exec_all`t1'"
        local x_title "% bottom quartile evasion rate cases - all audits, year t"
        local y_title "Execution rate - all audits, year t+1"
    }
    else if "`share'" == "share_botq_er_Algorithm" {
        local y_t     "share_exec_Algorithm`t'"
        local y_t1    "share_exec_Algorithm`t1'"
        local x_title "% bottom quartile evasion rate cases - Algo audits, year t"
        local y_title "Execution rate - algo audits, year t+1"
    }
    else if "`share'" == "share_botq_er_Inspectors" {
        local y_t     "share_exec_Inspectors`t'"
        local y_t1    "share_exec_Inspectors`t1'"
        local x_title "% bottom quartile evasion rate cases - Inspector audits, year t"
        local y_title "Execution rate - inspector audits, year t+1"
    }
    else {
...
esttab bureau_stats_1 ///
       bureau_stats_2 ///
       bureau_stats_3 ///
       using "$output\bureau_sample_stats.tex", replace ///
...
esttab bureau_has_1 ///
       bureau_has_2 ///
       bureau_has_3 ///
       using "$output\bureau_has_exec_void_t_t1.tex", replace ///
    main(sum) noobs nonote ///
    order( ///
        has_executed_all_t has_executed_Algorithm_t has_executed_Inspectors_t ///
        has_void_all_t     has_void_Algorithm_t     has_void_Inspectors_t ///
    ...
    varlabels( ///
        ...
        has_void_Algorithm_t            "Reported void algo audit" ///
        has_void_Inspectors_t     "Reported void inspector audit" ///
        has_med_er_all_t          "Reported any below-median evasion rate" ///
        has_med_er_Algorithm_t          "Reported below-median evasion rate algo audit" ///
        ...
        has_botq_er_Algorithm_t          "Reported bot-quartile  evasion rate algo audit" ///
        ...
        has_void_Algorithm_t1            "Reported void algo audit" ///
        has_void_Inspectors_t1     "Reported void inspector audit" ///
		has_med_er_all_t1          "Reported any below-median evasion rate" ///
        has_med_er_Algorithm_t1          "Reported below-median evasion rate algo audit" ///
...
esttab bureau_share_1 ///
       bureau_share_2 ///
       bureau_share_3 ///
       using "$output\bureau_share_exec_void_t_t1.tex", replace ///
    noobs nonote  ///
    main(mean ) ///
    aux(sd) ///
    order( ///
    ...
    varlabels( ///
        ...
        share_v_Algorithm_t           "Void rate, algo audits" ///
        share_v_Inspectors_t    "Void rate, inspector audits" ///
        share_med_er_all_t      "Share of below median ev. rate, all audits" ///
        share_med_er_Algorithm_t      "Share of below median ev. rate, algo audits" ///
        ...
        share_botq_er_Algorithm_t      "Share of bottom quartile ev. rate, algo audits" ///
        ...
        share_v_Algorithm_t1           "Void rate, algo audits" ///
        share_v_Inspectors_t1    "Void rate, inspector audits" ///
        share_med_er_all_t1      "Share of below median ev. rate, all audits" ///
        share_med_er_Algorithm_t1      "Share of below median ev. rate, algo audits" ///
