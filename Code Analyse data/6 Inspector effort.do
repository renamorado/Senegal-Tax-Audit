...
label var void_audit "Implemented audit without detected evasion"
...
rename n1 n_implemented
rename n0 n_notimplemented

mvencode n_implemented n_notimplemented void_audit* , mv(0) override

egen total_cases =  rowtotal(n_implemented n_notimplemented)
drop n_notimplemented void_audit0

reshape wide total_cases void_audit n_implemented, i(verificateur1 ) j(method)
...
order verificateur total_cases_* n_implemented* void_audit*

*** Total assigned cases
egen total_assigned_audits = rowtotal(total_cases*)
egen total_n_implemented = rowtotal(n_implemented*)
egen total_n_implemented = rowtotal(n_implemented*)
...
tab x2 if y2==1 & has_earliestdate!=. & (has_dateconfirmation!=. | has_datenotification!=.)

tab x2 has_earliestdate if (has_dateconfirmation!=. | has_datenotification!=.)
s
tab has_earliestdate x2 if  y2==1
tab has_dateconfirmation  x2 if y2==1
tab has_dateconfirmation  x2 if y2==1
