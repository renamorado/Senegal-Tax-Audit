...
count if taglist  ==1 // 272 lists

*ssc install egenmore, replace
egen quartiles_er = xtile(evasionrate), by(inspectorclusteryear)  nq(4)   // or nquantiles(4)
...
foreach share in share_exec_all share_exec_ALG share_exec_Inspectors ///
	...
	* ------------------------------------------------------------------
    * Case 4: All below median cases â€“ vs exec_all in t+1
    * ------------------------------------------------------------------
        ...
        * Scatter plot + linear fits + legend with equations
        ...
        , ///
            ...
            xscale(range(0 100)) xlabel(0(20)100) ///
            yscale(range(0 100)) ylabel(0(20)100) ///
            xtitle("% below median evasion rate - all audits, year t") ///
            ytitle("Execution rate - all audits, year t+1")
    ...
    * ------------------------------------------------------------------
    * Case 5: below median evasion rate cases - (ALG) vs exec_ALG in t+1
    * ------------------------------------------------------------------
        ...
        , ///
            ...
            xscale(range(0 100)) xlabel(0(20)100) ///
            yscale(range(0 100)) ylabel(0(20)100) ///
            xtitle("% below median evasion rate - Algo audits, year t") ///
            ytitle("Execution rate - all audits, year t+1")
    ...
    * ------------------------------------------------------------------
    * Case 6:below median evasion rate cases (Inspectors) vs exec_Inspectors in t+1
    * ------------------------------------------------------------------
        ...
        , ///
            ...
            xscale(range(0 100)) xlabel(0(20)100) ///
            yscale(range(0 100)) ylabel(0(20)100) ///
            xtitle("% below median evasion rate - Inspector audits, year t") ///
            ytitle("Execution rate - all audits, year t+1")
	...
	* ------------------------------------------------------------------
    * Case 7: All bottom quartile cases â€“ vs exec_all in t+1
    * ------------------------------------------------------------------
        ...
        * Scatter plot + linear fits + legend with equations
        ...
        , ///
            ...
            xscale(range(0 100)) xlabel(0(20)100) ///
            yscale(range(0 100)) ylabel(0(20)100) ///
            xtitle("% bottom quartile evasion rate cases- all audits, year t") ///
            ytitle("Execution rate - all audits, year t+1")
    ...
    * ------------------------------------------------------------------
    * Case 8: below bottom quartile rate cases - (ALG) vs exec_ALG in t+1
    * ------------------------------------------------------------------
        ...
        , ///
            ...
            xscale(range(0 100)) xlabel(0(20)100) ///
            yscale(range(0 100)) ylabel(0(20)100) ///
            xtitle("% bottom quartile evasion rate cases - Algo audits, year t") ///
            ytitle("Execution rate - all audits, year t+1")
    ...
    * ------------------------------------------------------------------
    * Case 9:below bottom quartile cases (Inspectors) vs exec_Inspectors in t+1
    * ------------------------------------------------------------------
        ...
        , ///
            ...
            xscale(range(0 100)) xlabel(0(20)100) ///
            yscale(range(0 100)) ylabel(0(20)100) ///
            xtitle("% bottom quartile evasion rate cases - Inspector audits, year t") ///
            ytitle("Execution rate - all audits, year t+1")
    ...
    * ------------------------------------------------------------------
    * Case 10: Execution (or void) rates t vs t+1 â€“ same measure both axes
    * ------------------------------------------------------------------
    else {
