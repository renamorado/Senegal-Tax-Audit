...
foreach share in share_exec_all share_exec_ALG share_exec_Inspectors ///
	...
	* ------------------------------------------------------------------
    * Case 4: All below median cases – vs exec_all in t+1
    * ------------------------------------------------------------------
	...
	* ------------------------------------------------------------------
    * Case 7: All bottom quartile cases – vs exec_all in t+1
    * ------------------------------------------------------------------
    ...
    * ------------------------------------------------------------------
    * Case 10: Execution (or void) rates t vs t+1 – same measure both axes
    * ------------------------------------------------------------------
    else {
